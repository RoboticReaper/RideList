...
export async function GET(req: Request) {
    ...
    try {
        ...
        // 3. Filter: trip departure > Today 00:00:00
        // 4. No status filtering (show cancelled, removed, etc)
        ...
        let query = `
            ...
            WHERE t.departure_time >= CURRENT_DATE::timestamp
            AND lb.status IN ('waiting_approval', 'joined_with_pay_window', 'pending_pay_confirmation_from_driver', 'confirmed')
        `;
